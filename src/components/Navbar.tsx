          ...
          >
            <div className="px-4 py-6 space-y-4">
              ...
              <div className="pt-4">
                <Link
                  to="/donate"
                  className="block w-full text-center bg-secondary-500 text-white py-3 px-4 rounded-lg hover:bg-secondary-600 transition-colors font-medium"
                  onClick={toggleMenu}
                >
                  <HandHeart className="w-4 h-4 mr-2 inline" />
                  Donate Now
                </Link>
              </div>
            </div>
