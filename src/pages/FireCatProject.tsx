...
const FireCatProject = () => {
  return (
    <ProjectPageLayout
      ...
      darkMode={true}
    >
      <h2 className="text-3xl font-bold mb-6">Case Study: FireCat's 6th SENSE Technology Platform</h2>
      ...
      <p>
        Our team provided an end-to-end solution called the 6th SENSE, combining sophisticated AI-driven 
      ...
      <p>
        ...
        safety, and operational efficiency of high-risk personnel. Our innovative platform and specialized 
